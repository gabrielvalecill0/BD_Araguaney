...
public class ExportBombonas {
    ...
    public ExportBombonas(List<Bombonas> listaDatos){
    ...
    for(Bombonas dato : listaDatos){
        ...
        Cell celda = fila.createCell(0);
        celda.setCellValue(dato.getIdBombona());
        ...
        celda = fila.createCell(2);
        celda.setCellValue(dato.getBombonasAComprar());
